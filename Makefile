...
firmware:
	...
	$(DOCKER_RUN) bash -c "rm -rf build && mkdir build && cd build && cmake .. -DLOGGER=$(LOGGER) -DEXTERNAL_MAX77958_TEST=$(EXTERNAL_MAX77958_TEST) -DMAX77958_FORCE_VBUS_DIAGNOSTIC=$(MAX77958_FORCE_VBUS_DIAGNOSTIC) -DMAX77958_DIAG_POLL_MS=$(MAX77958_DIAG_POLL_MS) $(BOARD_FLAGS) $(DRV8830_SCOPE_FLAGS) && make -j$(JOBS)"
